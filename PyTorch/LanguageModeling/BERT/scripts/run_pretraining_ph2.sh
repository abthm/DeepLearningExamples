...
BERT_CONFIG="/workspace/BERT/files/bert_config.json"
...
#set +x
#
#echo "finished pretraining phase 1"
...
CMD+=" --do_train --phase2 --resume_from_checkpoint --phase1_end_step=35"
CMD+=" --json-summary ${RESULTS_DIR}/dllogger.json "
